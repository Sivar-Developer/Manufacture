        ...
        <div class="mbr-row mbr-justify-content-center">
            <div class="video-title mbr-col-sm-12 align-center mbr-col-md-6">
                <h2 class="mbr-section-title mbr-fonts-style mbr-light display-2">
                    Short Film About<br><strong>Manufacture Engineering</strong></h2>
            </div>
            <div class="video-block"><amp-youtube width="16" height="9" layout="responsive" data-videoid="gCBerNzVQ4k"></amp-youtube>
...
<section class="content10 mbr-section article cid-qSa0rZAW5E" id="content10-c">

     
    <div class="container">
        <div class="mbr-row mbr-justify-content-center">
            <div class="mbr-text mbr-fonts-style mbr-col-sm-12 mbr-col-md-8 display-4">
                <blockquote>This Website is Created and Managed by Manufacture Students mentioned in website, for having a good and acknowledgement information about manufacture engineering collected from official koya website , wikipedia, and official international sites.</blockquote>
            </div>
        </div>
    </div>
</section>

<section class="content17 mbr-section cid-qSa67e28gU" id="content17-e">
        ...
        <div class="mbr-row mbr-justify-content-center">
            <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-4">
                ...
                <p class="mbr-text mbr-fonts-style align-left mbr-white display-4">
                    Manager of website<br>Koya University Student&nbsp;<br>Faculty of Engineering</p>             
            </div>
            
            <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-4">
                <h3 class="mbr-section-title mbr-fonts-style align-left mbr-bold mbr-white display-5">Samir Barzani</h3>
                <p class="mbr-text mbr-fonts-style align-left mbr-white display-4">
                    Manager of website<br>Koya University Student 
<br>Faculty of Engineering<br></p> 
            </div>
...
<section class="content4 mbr-section article cid-qSaa1pY3sX" id="content4-f">
