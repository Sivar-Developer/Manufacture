...
<body>
  ...
  <section class="menu cid-qS9YzvXW6o" id="menu1-u">
        ...
        <div class="mbr-row mbr-justify-content-center">
            <div class="mbr-col-sm-12 mbr-col-md-10 mbr-col-lg-8">
                <h3 class="mbr-fonts-style mbr-section-title mbr-light display-2">
                    Free E-Books and Resources</h3>
                <p class="mbr-text mbr-fonts-style display-7"><strong>You can download any PDF file of E-books for Manufacture Engineering:</strong></p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="mbr-row mbr-justify-content-center">
            <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-3">
                <div class="card-wrapper">
                    <div class="card-img">
                        <amp-img src="assets/images/41axyo0nxal.-sx370-bo1204203200-372x499.jpg" layout="responsive" width="254.99197860962568" height="383" alt="Mobirise">
            ...
            <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-3">
                <div class="card-wrapper">
                    <div class="card-img">
                        <amp-img src="assets/images/9780471330578-us-313x500.jpg" layout="responsive" height="383" width="254.78891257995735" alt="Mobirise">
                            
                        </amp-img>
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style align-left mbr-light display-2">HANDBOOK OF
<div>INDUSTRIAL
</div><div>ENGINEERING</div></h4>
                        <p class="mbr-text mbr-fonts-style align-left display-4">
            ...
            <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-3">
                <div class="card-wrapper">
                    <div class="card-img">
                        <amp-img src="assets/images/download-195x258.jpg" layout="responsive" height="383" width="255.33333333333331" alt="Mobirise">
                            
                        </amp-img>
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style align-left mbr-light display-2">Mechanical Engineer’s</h4>
                        <p class="mbr-text mbr-fonts-style align-left display-4">
            ...
            <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-3 last-child">
                <div class="card-wrapper">
                    <div class="card-img">
                        <amp-img src="assets/images/51lgi7mzbfl.-sx384-bo1204203200-386x499.jpg" layout="responsive" height="383" width="255.33333333333331" alt="Mobirise">
                            
                        </amp-img>
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style align-left mbr-light display-5">FUNDAMENTALS OF
...
<section class="features2 mbr-section cid-qSbk5cNnaw" id="features2-y">
    ...
    <div class="container">
        <div class="mbr-row mbr-justify-content-center">
            <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-3">
                <div class="card-wrapper">
                    <div class="card-img">
                        <amp-img src="assets/images/download-1-200x251.jpg" layout="responsive" width="254.82470119521912" height="383" alt="Mobirise">
                            
                        </amp-img>
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style align-left mbr-light display-2">FUNDAMENTALS OF
 ENGINEERING 
<div>THERMODYNAMIC</div></h4>
            ...
            <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-3">
                <div class="card-wrapper">
                    <div class="card-img">
                        <amp-img src="assets/images/fundamentals-of-modern-manufacturing-4th-edition-by-groover-1-638-510x638.jpg" layout="responsive" height="382" width="254.86656200941917" alt="Mobirise">
...
<br>Fourth Edition</p>
            ...
            <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-3">
                <div class="card-wrapper">
                    <div class="card-img">
                        <amp-img src="assets/images/9781420089271-432x648.jpg" layout="responsive" height="383" width="255.33333333333331" alt="Mobirise">
                            
                        </amp-img>
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style align-left mbr-light display-2">Product Design
<div>for Manufacture
</div><div>and Assembly</div></h4>
                        <p class="mbr-text mbr-fonts-style align-left display-4">
                            Third Edition
                        </p>
                        <div class="mbr-section-btn align-left"><a class="btn btn-sm btn-secondary display-4" href="https://mobirise.com">
            ...
            <div class="card mbr-col-sm-12 mbr-col-md-6 mbr-col-lg-3 last-child">
                <div class="card-wrapper">
                    <div class="card-img">
                        <amp-img src="assets/images/9780824799144-454x648.jpg" layout="responsive" height="383" width="255.33333333333331" alt="Mobirise">
                            
                        </amp-img>
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style align-left mbr-light display-5">INTRODUCTION TO
<div>MANUFACTURING
</div><div>PROCESSES AND
</div><div>MATERIALS</div></h4>
